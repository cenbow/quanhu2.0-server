...
import com.yryz.quanhu.support.id.service.WorkerIdAssigner;
...
/**
 *  * Represents an implementation of {@link DefaultUidService}
 *
 ...
 *
 * The {@link DefaultUidService#parseUID(long)} is a tool method to parse the bits
 *
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
 ...
 *
 */
public class DefaultUidServiceImpl implements DefaultUidService, InitializingBean {
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultUidServiceImpl.class);
