...
public enum EventEnum {
	...
	/** 发布资源 */
	CREATE_RESOURCE("3", "发布资源", "每日累计操作N次触发(包含积分、成长、热度)"),
	/** 点赞 */
	LIKE("4", "点赞", "每日累计操作N次触发(包含积分、热度)"),
	/** 评论 */
	COMMENT("5", "评论", "每日累计操作N次触发(包含积分、热度)"),
	/** 分享 */
	SHARE("6", "分享", "每日累计操作N次触发(包含积分、热度)"),
	/** 收藏 */
	COLLECTION("7", "收藏", "每日累计操作N次触发(包含积分、热度)"),
	/** 充值 */
	RECHARGE("8", "充值", "每次触发(积分)"),
	/** 资源购买 */
	RESOURCE_PAY("9", "资源购买", "每次触发 (积分)"),
	/** 打赏 */
	REWARD("10", "打赏", "每次触发(积分)"),
	/** 会员注册 */
	REGISTER("11", "会员注册", "一次性触发"),
	/** 资料完善 */
	USER_DATA_IMPROVE("12", "资料完善", "一次性触发"),
	/** 阅读 */
	READ_RESOURCE("13", "阅读", "(热度)"),
	/** 回帖（参与话题） */
	REPLY_POST("14", "回帖", "每日累计操作/次触发(积分、热度)"),
	/** 签到 */
	...
	/** 成为认证达人 */
	STAR_AUTH_SUCCESS("19","成为认证达人","成为认证达人"),
	...
	/** 用户发布问题  */
	CREATE_QUESTION("22","用户发布问题","用户发布问题"),
	
	/** 用户问题被回答  */
	QUESTION_ANSWER("23","用户问题被回答","用户问题被回答"),
		
	/** 邀请好友注册奖励事件 */
	INVITER_REGISTER("24","邀请好友注册","邀请好友注册奖励500积分"),
