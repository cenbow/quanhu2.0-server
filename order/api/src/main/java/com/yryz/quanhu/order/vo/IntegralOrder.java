...
public class IntegralOrder implements Serializable {
	...
	public IntegralOrder(String custId, String orderId, Integer orderType, Long cost, Long accountSum, String productId,
	...
	public String toString() {
		return "IntegralOrder [custId=" + custId + ", orderId=" + orderId + ", orderType=" + orderType + ", cost="
