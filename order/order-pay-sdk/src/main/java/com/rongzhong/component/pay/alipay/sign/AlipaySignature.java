 ...
 */
package com.rongzhong.component.pay.alipay.sign;
...
import com.rongzhong.component.pay.alipay.codec.Base64;
import com.rongzhong.component.pay.alipay.util.SignType;
import com.rongzhong.component.pay.alipay.util.StreamUtil;;
...
public class AlipaySignature {
    ...
    public static String rsa256Sign(String content, String privateKey,
        ...
        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(SignType.RSA,
                new ByteArrayInputStream(privateKey.getBytes()));

            java.security.Signature signature = java.security.Signature
                .getInstance(RSA.SIGN_SHA256RSA_ALGORITHMS);
    ...
    public static String rsaSign(String content, String privateKey,
        ...
        try {
            ...
            java.security.Signature signature = java.security.Signature
                .getInstance(RSA.SIGN_ALGORITHMS);
    ...
    public static String rsaEncrypt(String content, String publicKey,
                                    String charset) throws AlipayApiException {
        try {
            PublicKey pubKey = getPublicKeyFromX509(SignType.RSA,
                new ByteArrayInputStream(publicKey.getBytes()));
            Cipher cipher = Cipher.getInstance(SignType.RSA);
