...
//	private static String MerKeyPath = "D:\\chinapay\\MerPrK_808080301501303_20160922151442.key";
//	private static String pay_url = "http://sfj.chinapay.com/dac/SinPayServletGBK";
//	private static String PubKeyPath = "D:\\chinapay\\PgPubk.key";
//	private static String merId = "808080301501303";
	...
	public static TransactionBean buildTransaction(){
		String txnAmt = "1";
	...
	public static TransactionBean buildTransaction(String txnAmt ,String orderId ,String name ,String bankCardNo ,String bankName){
...
//		System.out.println("转换成后数据：" + plainData);
	...
	public static boolean sendData(TransactionBean transactionBean){
	...
	public static void main(String[] args) {
		ChinapayCash cash = new ChinapayCash();
		TransactionBean transactionBean = cash.buildTransaction();
		cash.sendData(transactionBean);
	}
