...
public class UnionpayConfig {
	...
	public void payCash(String merId , String txnAmt ,String orderId ,String name ,String bankCardNo){
		...
		String accNo = AcpService.encryptData(bankCardNo, DemoBase.encoding_UTF8); //这里测试的时候使用的是测试卡号，正式环境请使用真实卡号
...
//		customerInfoMap.put("certifId", "341126197709218366");		    //证件号码
		...
		String customerInfoStr = AcpService.getCustomerInfo(customerInfoMap,bankCardNo,DemoBase.encoding_UTF8);				
	...
	public static void main(String[] args) {
		...
		config.payCash("777290058110097", "100", "20160822010" ,name ,bankCardNo );
	}
