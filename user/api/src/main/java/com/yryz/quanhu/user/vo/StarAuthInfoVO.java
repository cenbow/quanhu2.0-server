...
public class StarAuthInfoVO implements Serializable {
	 ...
	 */
	public StarAuthInfoVO(String userId, Byte auditStatus, String operational, String auditFailReason) {
		super();
		this.userId = userId;
		this.auditStatus = auditStatus;
	 ...
	 * @param recommendDesc
	 */
	public StarAuthInfoVO(String userId, Byte recommendStatus, String operational, String recommendOperate,
	 ...
	 */
	public StarAuthInfoVO(String userId, Integer recommendHeight) {
		super();
		this.userId = userId;
		this.recommendHeight = recommendHeight;
	}
